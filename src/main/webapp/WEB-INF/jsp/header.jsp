...
<head>
    ...
    <style type="text/css">
        ...
        .headImageContent{position: absolute;margin: -338px 0 0 8%; font-size: 1.5em;color: black;font-weight: 600;}
...
<body>
   ...
   <header role="banner">
        <div class="container navContainer" style="margin-top: 0px;">
           <a class="skip-navigation sr-only sr-only-focusable" href="#page-title">Skip Navigation</a>
            <div class="navbar-header active">
                <a class="brand pull-left" href="index.html">
                    <img src="${pageContext.request.contextPath}/static/Images/eQualityNew.jpg" width="180" height="180" class="mainLogo img-responsive" alt="Accessible+ logo - place for company logo" role="logo">
