...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/static/css/checkout.css">
...
<body>
	...
	<div class="container">
		...
		<button class="tablink" onclick="openPage('mplans', this, 'black')">
			<i class="fa fa-money" style="font-size: 25px"></i>&nbsp;&nbsp;My
			Plans
		</button>
		<button class="tablink" onclick="openPage('settings', this, 'black')">
			<i class="fa fa-cog " style="font-size: 25px"></i>&nbsp;&nbsp;Settings
		</button>
		<br>
		...
		<div id="Home" class="tabcontent general-form">
			<div class="tab-container">
				...
				<p>
					<span class="glyphicon glyphicon-asterisk"></span>&nbsp;&nbsp;Why
					do we use it?
				</p>
				<p>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
						class="glyphicon glyphicon-pencil"></span>&nbsp;It is a long
					...
					the like).
				<p>
					<span class="glyphicon glyphicon-asterisk"></span>&nbsp;&nbsp;Where
					does it come from?
				</p>
				<p>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
						class="glyphicon glyphicon-pencil"></span>&nbsp;Contrary to
				...
				<p>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
						class="glyphicon glyphicon-pencil"></span>&nbsp;Lorem Ipsum is
		...
		<div id="Personaldetails" class="tabcontent general-form text-center">
			...
			<div class="tab-container">
				...
				<div>
					<label for="clientaccount_email">Email</label> <input type="text"
						id="clientaccount_email" name="clientaccount_email"
						value="${userDetails.email}">
				</div>
				<div>
					<label for="clientaccount_company_name">Company Name</label> <input
						type="text" id="clientaccount_company_name"
						name="clientaccount_company_name"
						value="${userDetails.companyName}">
				</div>
				<div>
					<label for="clientaccount_job_title">Job Title</label> <select
						id="clientaccount_job_title" name="clientaccount_job_title"
						required="required">
						<c:choose>
						...
						<option value="sales_business_development">Sales /
							Business Development</option>
						<option value="marketing_public_relations">Marketing
				...
				<div>
					<label for="socialserver_corebundle_clientaccount_country"
						class="required">Country</label> <select
						id="socialserver_corebundle_clientaccount_country"
				...
				<div>
					<label for="clientaccount_timezone" class="required">Time
						Zone</label> <select id="clientaccount_timezone"
						...
						<option value="America/Chihuahua">(GMT-7)
							America/Chihuahua</option>
						<option value="America/Hermosillo">(GMT-7)
						...
						<option value="America/Bahia_Banderas">(GMT-6)
						...
						<option value="America/Grand_Turk">(GMT-5)
							America/Grand_Turk</option>
						<option value="America/Guayaquil">(GMT-5)
						...
						<option value="America/Port-au-Prince">(GMT-5)
						...
						<option value="America/Argentina/San_Luis">(GMT-4)
						...
						<option value="America/Boa_Vista">(GMT-4)
							America/Boa_Vista</option>
						<option value="America/Campo_Grande">(GMT-4)
						...
						<option value="America/Martinique">(GMT-4)
							America/Martinique</option>
						<option value="America/Montserrat">(GMT-4)
							America/Montserrat</option>
						<option value="America/Port_of_Spain">(GMT-4)
							America/Port_of_Spain</option>
						<option value="America/Porto_Velho">(GMT-4)
							America/Porto_Velho</option>
						<option value="America/Puerto_Rico">(GMT-4)
							America/Puerto_Rico</option>
						<option value="America/Rio_Branco">(GMT-4)
							America/Rio_Branco</option>
						<option value="America/Santiago">(GMT-4) America/Santiago</option>
						<option value="America/Santo_Domingo">(GMT-4)
							America/Santo_Domingo</option>
						<option value="America/St_Barthelemy">(GMT-4)
						...
						<option value="America/St_Thomas">(GMT-4)
							America/St_Thomas</option>
						<option value="America/St_Vincent">(GMT-4)
						...
						<option value="Antarctica/Palmer">(GMT-4)
							Antarctica/Palmer</option>
						<option value="Atlantic/Bermuda">(GMT-4) Atlantic/Bermuda</option>
						<option value="America/Araguaina">(GMT-3)
							America/Araguaina</option>
						<option value="America/Argentina/Buenos_Aires">(GMT-3)
							America/Argentina/Buenos_Aires</option>
						<option value="America/Argentina/Catamarca">(GMT-3)
							America/Argentina/Catamarca</option>
						<option value="America/Argentina/Cordoba">(GMT-3)
							America/Argentina/Cordoba</option>
						<option value="America/Argentina/Jujuy">(GMT-3)
							America/Argentina/Jujuy</option>
						<option value="America/Argentina/La_Rioja">(GMT-3)
							America/Argentina/La_Rioja</option>
						<option value="America/Argentina/Mendoza">(GMT-3)
							America/Argentina/Mendoza</option>
						<option value="America/Argentina/Rio_Gallegos">(GMT-3)
							America/Argentina/Rio_Gallegos</option>
						<option value="America/Argentina/Salta">(GMT-3)
							America/Argentina/Salta</option>
						<option value="America/Argentina/San_Juan">(GMT-3)
							America/Argentina/San_Juan</option>
						<option value="America/Argentina/Tucuman">(GMT-3)
							America/Argentina/Tucuman</option>
						<option value="America/Argentina/Ushuaia">(GMT-3)
						...
						<option value="America/Fortaleza">(GMT-3)
						...
						<option value="America/Montevideo">(GMT-3)
							America/Montevideo</option>
						<option value="America/Paramaribo">(GMT-3)
						...
						<option value="America/Sao_Paulo">(GMT-3)
							America/Sao_Paulo</option>
						<option value="Antarctica/Rothera">(GMT-3)
						...
						<option value="Atlantic/South_Georgia">(GMT-2)
							Atlantic/South_Georgia</option>
						<option value="America/Scoresbysund">(GMT-1)
							America/Scoresbysund</option>
						<option value="Atlantic/Azores">(GMT-1) Atlantic/Azores</option>
						<option value="Atlantic/Cape_Verde">(GMT-1)
						...
						<option value="Africa/Casablanca">(GMT+0)
						...
						<option value="Africa/Nouakchott">(GMT+0)
						...
						<option value="America/Danmarkshavn">(GMT+0)
						...
						<option value="Atlantic/Reykjavik">(GMT+0)
							Atlantic/Reykjavik</option>
						<option value="Atlantic/St_Helena">(GMT+0)
						...
						<option value="Europe/Isle_of_Man">(GMT+0)
						...
						<option value="Africa/Brazzaville">(GMT+1)
						...
						<option value="Africa/Libreville">(GMT+1)
						...
						<option value="Africa/Porto-Novo">(GMT+1)
						...
						<option value="Europe/Bratislava">(GMT+1)
						...
						<option value="Europe/Copenhagen">(GMT+1)
						...
						<option value="Europe/Luxembourg">(GMT+1)
						...
						<option value="Europe/San_Marino">(GMT+1)
						...
						<option value="Africa/Lubumbashi">(GMT+2)
						...
						<option value="Europe/Simferopol">(GMT+2)
						...
						<option value="Europe/Zaporozhye">(GMT+2)
							Europe/Zaporozhye</option>
						<option value="Africa/Addis_Ababa">(GMT+3)
							Africa/Addis_Ababa</option>
						<option value="Africa/Asmara">(GMT+3) Africa/Asmara</option>
						<option value="Africa/Dar_es_Salaam">(GMT+3)
						...
						<option value="Antarctica/Mawson">(GMT+5)
						...
						<option value="Antarctica/Vostok">(GMT+6)
						...
						<option value="Asia/Yekaterinburg">(GMT+6)
						...
						<option value="Asia/Novokuznetsk">(GMT+7)
						...
						<option value="Asia/Kuala_Lumpur">(GMT+8)
						...
						<option value="Australia/Eucla">(GMT+8.75)
						...
						<option value="Australia/Adelaide">(GMT+9.5)
							Australia/Adelaide</option>
						<option value="Australia/Broken_Hill">(GMT+9.5)
							Australia/Broken_Hill</option>
						<option value="Australia/Darwin">(GMT+9.5)
							Australia/Darwin</option>
						<option value="Antarctica/DumontDUrville">(GMT+10)
							Antarctica/DumontDUrville</option>
						<option value="Asia/Yakutsk">(GMT+10) Asia/Yakutsk</option>
						<option value="Australia/Brisbane">(GMT+10)
							Australia/Brisbane</option>
						<option value="Australia/Currie">(GMT+10)
							Australia/Currie</option>
						<option value="Australia/Hobart">(GMT+10)
							Australia/Hobart</option>
						<option value="Australia/Lindeman">(GMT+10)
							Australia/Lindeman</option>
						<option value="Australia/Melbourne">(GMT+10)
							Australia/Melbourne</option>
						<option value="Australia/Sydney">(GMT+10)
						...
						<option value="Pacific/Norfolk">(GMT+11.5)
							Pacific/Norfolk</option>
						<option value="Antarctica/McMurdo">(GMT+12)
							Antarctica/McMurdo</option>
						<option value="Antarctica/South_Pole">(GMT+12)
						...
						<option value="Pacific/Auckland">(GMT+12)
							Pacific/Auckland</option>
						<option value="Pacific/Fiji">(GMT+12) Pacific/Fiji</option>
						<option value="Pacific/Funafuti">(GMT+12)
							Pacific/Funafuti</option>
						<option value="Pacific/Kwajalein">(GMT+12)
					...
					<div class="col-sm-3">
						<p style="font-weight: 100">
							...
							<strong
								...
								<sub style="font-size: 1.3rem;">p/m</sub>
							</strong>
						</p>
		...
		<div id="settings" class="tabcontent general-form text-center">
			<div class="tab-container">
	...
	<div id="myModal" class="modal">
		...
		<div class="modal-content content-div"
			style="font-size: 1.0rem; background-color: #ffffff;">
			<p>Your password has been successfully updated</p>
			<input type="button" class="btn btn-default"
				value="Click Here to Proceed" onclick="redirectMyProfile();">
		</div>
	</div>
	...
	<div id="pmyModal" class="modal">
		...
		<div class="modal-content content-div"
			...
			<input type="button" class="btn btn-default"
				value="Click Here to Proceed" onclick="redirectMyPersonalInfo();">
		</div>
	</div>
				...
				.click(
						function(e) {
							...
							var changePasswordDetails = {
								...
								'clientaccount_Newpwd' : $(
										"#clientaccount_Newpwd").val(),
								'clientaccount_cnfpwd' : $(
										"#clientaccount_cnfpwd").val()
							}
				...
				.click(
						function(e) {
							...
							var personalDetails = {
								...
								'clientaccount_name' : $("#clientaccount_name")
										.val(),
								'clientaccount_lname' : $(
										"#clientaccount_lname").val(),
								'clientaccount_email' : $(
										"#clientaccount_email").val(),
								'clientaccount_company_name' : $(
										"#clientaccount_company_name").val(),
								'clientaccount_job_title' : $(
										"#clientaccount_job_title").val(),
								'clientaccount_website' : $(
										"#clientaccount_website").val(),
								'clientaccount_timezone' : $(
										"#clientaccount_timezone").val(),
								'socialserver_corebundle_clientaccount_country' : $(
										"#socialserver_corebundle_clientaccount_country")
										.val()
