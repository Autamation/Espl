		...
		<div class="row ">
			<div
				...
				<form id="loginFormId" action="#" method="post" model="user"
					...
					<fieldset class="sign-in-box shadow p-3 mb-5 bg-white rounded">
						<div class="text-center"> <!-- style="color: #3366FF;" -->
							<h2 style="margin-bottom:20px;font-weight: bold;">eQuality account sign in</h2>
						</div>
						<!-- <hr class="colorgraph">  -->
						...
						<div class="form-group">
						 ...
						 <span class="button-checkbox">
							<!-- <button type="button" class="btn" >RememberMe</button>
						...
						<!-- <hr class="colorgraph"> -->
							<div class="col-xs-6 col-sm-6 col-md-6">
								<input type="submit" id="loginSubmit" name="loginSubmit"
									class="btn btn-info btn-block btn-lg" value="Sign In">
							</div>
							<div class="col-xs-6 col-sm-6 col-md-6" style="margin-bottom:20px;">
								<a href="${pageContext.request.contextPath}/signup.html"
									class="btn btn-lg btn-default btn-block" style="background-color: #444;color:white">Register</a>
							</div>
