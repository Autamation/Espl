...
<body>
	...
	<div id="mainImageDiv" role="image slider for visual appeal">
		...
		<div class="slickit">
			<div>
				<image
					src="${pageContext.request.contextPath}/static/Images/web_accessibility.png"
					class="headImage" id="headImage1"
					alt="header hands typing on keyboard" />
			</div>
					...
					<div class="col-md-12">
						...
						<div class="center">
							<div class="col-md-offset-1 col-md-10 col-md-offset-1 "
								style="text-align: justify; letter-spacing: 1px; word-spacing: 3px;">
								<p>eQuality Labs works towards a mission to provide equal
									access to technology for people with disabilities all over the
									world whether you want to learn about accessibility,
									demonstrate the accessibility readiness of your website, prove
									your skills and capabilities around accessibility or
									participate in the community. eQuality Labs can be your
									partner. The team of accessibility specialists who support
									eQuality Labs has a wide range of experience and can provide
				...
				<div class="row">
					<div class="col-md-4">
						<div class="half-panel" href="#">
							<div class="half-panel-heading">
								<img class="" alt="Project planning"
									src="${pageContext.request.contextPath}/static/Images/certi.jpg">
							</div>
							<div class="half-panel-body">
								<div class="half-panel-icon">
									<span aria-hidden="true"><i class="fa fa-sun-o"></i></span><span
										class="sr-only">plane Icon</span>
								</div>
								<h3 class="half-panel-title">TrustMark</h3>
								<ul>
									<li>Neutral Accreditation of best accessibility practices
										for your website.</li>
									<li>Display eQuality badge on your website.</li>
									<li>Show your commitment to the people with disabilities
										visiting your website.</li>
									<li>Explicitly state that your website is accessibility
										ready.</li>
								</ul>
								<p>
									<a href="trust_mark.html">Read More...</a>
								</p>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="half-panel" href="#">
							<div class="half-panel-heading">
								<img class="" alt="Project planning"
									src="${pageContext.request.contextPath}/static/Images/jump.jpg"
									style="height: 236px;">
							</div>
							<div class="half-panel-body">
								<div class="half-panel-icon">
									<span aria-hidden="true"><i class="fa fa-bookmark-o"></i></span><span
										class="sr-only">user Icon</span>
								</div>
								<h3 class="half-panel-title">Training & Certification</h3>
								<ul>
									<li>Aggregation of a wide range of relevant trainings for
										various job roles</li>
									<li>Relevant learning paths for various job roles CXO to
										developers</li>
									<li>Prove your competence and skills with an eQuality
										certification</li>
								</ul>
								<br />
								<p>
									<a href="training&Certification.html">Read More...</a>
								</p>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="half-panel" href="#">
							<div class="half-panel-heading">
								<img class="" alt="Project planning"
									src="${pageContext.request.contextPath}/static/Images/community1.jpg">
							</div>
							<div class="half-panel-body">
								<div class="half-panel-icon">
									<span aria-hidden="true"><i class="fa fa-users"></i></span><span
										class="sr-only">cogs Icon</span>
								</div>
								<h3 class="half-panel-title">Community</h3>
								<ul>
									<li>Get involved with accessibility and share your
										experiences</li>
		...
		<section class="alternate bottomMargin50">
			<div class="container">
				...
				<div class="row">
						...
						<div class="smallSlick">
							<div>
								...
								<p>
									...
									internet. They consist of a set of guidelines for making
									content accessible, primarily for people with disabilities, but
									also for all user agents, including highly limited devices,
									such as mobile phones..." (source: <a
										href="https://en.wikipedia.org/wiki/Web_Content_Accessibility_Guidelines"
										target="_blank">Wikipedia</a>).
								</p>
								<img class="thumbnail img-responsive"
									src="${pageContext.request.contextPath}/static/Images/p1.png"
					...
					<div class="col-md-6 col-sm-12">
						<h4>
							Why Go <strong>Accessible?</strong>
						</h4>
						<div id="accordion-container" class="accordion-dark">
							<h3>508 Compliance</h3>
							<div>If you're working for a government organization,
								chances are you're aware of 508 compliance. It's a law that
								requires federal agencies (or those receiving federal funds for
								a project) to make their e-materials, like e-learning courses
								and documents, accessible to people with disabilities. While
								more of a stick than a carrot 508 compliance is a very large
								reason that accessibility may be important to you!</div>
							<h3>Business Sense</h3>
							<div>A full 20 percent of Americans live with one type of
								disability or another. So, if you're an online retailer and your
								website isn't fully accessible, 20 percent of your potential
								customer base can't effectively navigate your site—and you miss
								out on their business. Now, let's take it from another angle. In
								the 2010 workplace, 16.6 percent of the typical working age
								population (aged 21 - 64) had a disability. That's 30 million
								people! Think about this from a training perspective. Without
								accessible training, your employees will have a skill disparity
								within your own organization and that's a human capital cost.
								How much more capable would your workforce be if your training
								materials were fully accessible? Don't intentionally ignore a
								portion of your workforce they might find a more accommodating
								workplace with your competitors.</div>
							<h3>Company Morale</h3>
							<div>The it's the right thing to do argument may not win
								over accountants watching the corporate purse strings, but
								there's something to be said about caring for your fellow human
								beings. In fact, you may find that your employees appreciate the
								fact that their organization cares enough to require that
								training materials are accessible for all employees.</div>
							<h3>Larger Societal Impact</h3>
							<div>A 2012 study from the European Union found that as
								many as 110 million elderly and disabled Europeans are at risk
								of being digitally excluded. If certain accessibility
								accommodations were in place, the benefit to users would be
								nearly €411 billion. To be fair, it would cost companies
								approximately €2.39 to implement the accommodations, but the
								gain of €411 billion is far greater than the investment.</div>
							<h3>Corporate Goodwill</h3>
							<div>Organizations supporting people with disabilities
								often foster community and connection among their members. And
								in the United States, it is estimated that these members have a
								collective disposable income of over $250 billion. Companies
								that provide support to these organizations are much more likely
								to receive the benefit of that disposable income. So while it
								may be difficult to put an actual price tag on goodwill, one
								only needs to look at the potential ROI to see why accessibility
								makes sense!</div>
 ...
 --%>
	...
	<!-- endbuild -->
	<script
		src="${pageContext.request.contextPath}/static/vendor/globalassets/scripts/assets.responsive.js"></script>

	<script
		src="${pageContext.request.contextPath}/static/vendor/share/4.0/js/sharewidget-4.0.js"></script>
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/static/vendor/slick-1.5.7/slick.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/static/vendor/portfolio/jquery.quicksand.js"></script>
	<script
		src="${pageContext.request.contextPath}/static/vendor/back-to-top/main.js"></script>
	<script type="text/javascript"
